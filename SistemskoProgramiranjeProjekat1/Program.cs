...
namespace SistemskoProgramiranjeProjekat1
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("- Web server pokrenut na http://localhost:5050/");
            Console.WriteLine("- Root folder: " + rootPath);

            while (true)
            {
                HttpListenerContext context = listener.GetContext();
                ThreadPool.QueueUserWorkItem(o => ObradiZahtev(context));
            }
        }
